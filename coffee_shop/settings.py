...
SECRET_KEY = 'django-insecure-p+_tk%+dubj=77c_8i0+!+0u*w&&7o=bs^16_kn-@umw!*rce&'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #esto hace que django tome el template de fuera como el defecto
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
